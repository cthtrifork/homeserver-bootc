...
tar -zxvf /tmp/gh-cli.tar.gz -C "$BIN_DIR"/ bin/gh --strip-components=1 --exclude=LICENSE --exclude=README.md --exclude=licenses
...
KUBECTLCNPG_VERSION="v1.27.1" # renovate: datasource=github-releases depName=cloudnative-pg/cloudnative-pg
...
COSIGN_VERSION="v3.0.2" # renovate: datasource=github-releases depName=sigstore/cosign
curl -sLo /tmp/cosign \
