...
log "Installing witr"
WITR_VERSION="v0.2.1" # renovate: datasource=github-releases depName=pranshuparmar/witr
...
FRESH_VERSION="v0.1.74" # renovate: datasource=github-releases depName=sinelaw/fresh
