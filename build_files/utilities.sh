...
extract_tar "$HELM_TGZ" -C "$BIN_DIR"/ --strip-components=1
...
extract_tar "$FRESH_TGZ" --strip-components=1 --exclude=themes --exclude=plugins --exclude CHANGELOG.md
