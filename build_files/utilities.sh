...
TALOSCTL_VERSION="v1.12.1" # renovate: datasource=github-releases depName=siderolabs/talos
...
LAZYGIT_VERSION="v0.58.1" # renovate: datasource=github-releases depName=jesseduffield/lazygit
...
log "Installing witr"
WITR_VERSION="v0.2.4" # renovate: datasource=github-releases depName=pranshuparmar/witr
