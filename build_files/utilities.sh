...
log "Installing witr"
WITR_VERSION="v0.1.3" # renovate: datasource=github-releases depName=pranshuparmar/witr
...
FRESH_VERSION="v0.1.69" # renovate: datasource=github-releases depName=sinelaw/fresh
