...
log "Installing witr"
WITR_VERSION="v0.1.8" # renovate: datasource=github-releases depName=pranshuparmar/witr
...
FRESH_VERSION="v0.1.71" # renovate: datasource=github-releases depName=sinelaw/fresh
