...
OMNICTL_VERSION="v1.9.0" # renovate: datasource=github-releases depName=siderolabs/omni
...
log "Installing doxx"
DOXX_VERSION="v0.1.4" # renovate: datasource=github-releases depName=bgreenwell/doxx
...
DOCKER_SCOUT_VERSION="v1.22.0" # renovate: datasource=github-releases depName=docker/scout-cli
