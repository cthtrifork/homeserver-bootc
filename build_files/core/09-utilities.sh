...
TALOSCTL_VERSION="v1.12.3" # renovate: datasource=github-releases depName=siderolabs/talos
...
FRESH_VERSION="v0.1.99" # renovate: datasource=github-releases depName=sinelaw/fresh
