...
GH_CLI_VERSION="v2.94.0" # renovate: datasource=github-releases depName=cli/cli
...
KUBEVIRT_VERSION="v1.8.3" # renovate: datasource=github-releases depName=kubevirt/kubectl-virt-plugin
...
FLUX_MCP_VERSION="v0.52.0" # renovate: datasource=github-releases depName=controlplaneio-fluxcd/flux-operator
...
FRESH_VERSION="v0.4.0" # renovate: datasource=github-releases depName=sinelaw/fresh
