...
FRESH_VERSION="v0.2.17" # renovate: datasource=github-releases depName=sinelaw/fresh
...
CRANE_VERSION=v0.21.3 # renovate: datasource=github-releases depName=google/go-containerregistry
