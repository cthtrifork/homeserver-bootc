...
TALOSCTL_VERSION="v1.12.2" # renovate: datasource=github-releases depName=siderolabs/talos
...
FRESH_VERSION="v0.1.95" # renovate: datasource=github-releases depName=sinelaw/fresh
