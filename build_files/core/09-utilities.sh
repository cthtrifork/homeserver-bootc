...
GH_CLI_VERSION="v2.87.2" # renovate: datasource=github-releases depName=cli/cli
...
FRESH_VERSION="v0.2.5" # renovate: datasource=github-releases depName=sinelaw/fresh
