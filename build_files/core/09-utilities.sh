...
KUBECTL_VERSION="v1.36.3" # renovate: datasource=github-releases depName=kubernetes/kubernetes
...
OMNICTL_VERSION="v1.10.0" # renovate: datasource=github-releases depName=siderolabs/omni
