...
KUBECTL_VERSION="v1.36.0" # renovate: datasource=github-releases depName=kubernetes/kubernetes
...
download_if_missing_cmd "$FLUX_MCP_TGZ" /ctx/build_files/github-release-url.sh controlplaneio-fluxcd/flux-operator "flux-operator-mcp_${FLUX_MCP_VERSION#v}-${MACHINE}.${PLATFORM_ARCH}.tar.gz" "$FLUX_MCP_VERSION"
...
TALOSCTL_VERSION="v1.13.0" # renovate: datasource=github-releases depName=siderolabs/talos
