...
OMNICTL_VERSION="v1.6.4" # renovate: datasource=github-releases depName=siderolabs/omni
OMNICTL_BIN="$(tmp_name omnictl "$OMNICTL_VERSION" bin)"
download_if_missing_cmd "$OMNICTL_BIN" /ctx/build_files/github-release-url.sh siderolabs/omni "${MACHINE}.${PLATFORM_ARCH}" "$OMNICTL_VERSION"
...
LAZYGIT_VERSION="v0.61.0" # renovate: datasource=github-releases depName=jesseduffield/lazygit
...
FRESH_VERSION="v0.2.21" # renovate: datasource=github-releases depName=sinelaw/fresh
...
CRANE_VERSION=v0.21.4 # renovate: datasource=github-releases depName=google/go-containerregistry
