...
TALOSCTL_VERSION="v1.12.7" # renovate: datasource=github-releases depName=siderolabs/talos
...
FRESH_VERSION="v0.3.0" # renovate: datasource=github-releases depName=sinelaw/fresh
