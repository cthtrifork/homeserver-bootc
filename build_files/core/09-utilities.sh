...
OMNICTL_VERSION="v1.7.3" # renovate: datasource=github-releases depName=siderolabs/omni
...
FRESH_VERSION="v0.3.7" # renovate: datasource=github-releases depName=sinelaw/fresh
