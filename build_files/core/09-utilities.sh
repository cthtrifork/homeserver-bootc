...
GH_CLI_VERSION="v2.92.0" # renovate: datasource=github-releases depName=cli/cli
...
KUBECTL_VERSION="v1.36.1" # renovate: datasource=github-releases depName=kubernetes/kubernetes
...
KUBELOGIN_VERSION="v1.36.1" # renovate: datasource=github-releases depName=int128/kubelogin
...
KUBEVIRT_VERSION="v1.8.2" # renovate: datasource=github-releases depName=kubevirt/kubectl-virt-plugin
...
# https://github.com/yashbhutwala/kubectl-df-pv/releases/download/v0.4.1/kubectl-df-pv_v0.4.1_linux_amd64.tar.gz
log "Installing kubectl-df-pv"
KUBECTLDFPV_VERSION="v0.4.1" # renovate: datasource=github-releases depName=yashbhutwala/kubectl-df-pv
KUBECTLDFPV_TGZ="$(tmp_name kubectl-cnpg "$KUBECTLDFPV_VERSION" tar.gz)"
download_if_missing_cmd "$KUBECTLDFPV_TGZ" /ctx/build_files/github-release-url.sh yashbhutwala/kubectl-df-pv "kubectl-df-pv.*_${MACHINE}_${PLATFORM_ARCH}.tar.gz" "$KUBECTLDFPV_VERSION"
extract "$KUBECTLDFPV_TGZ"
...
OMNICTL_VERSION="v1.8.0" # renovate: datasource=github-releases depName=siderolabs/omni
...
FLUX_MCP_VERSION="v0.50.0" # renovate: datasource=github-releases depName=controlplaneio-fluxcd/flux-operator
...
log "Installing flux"
FLUX_VERSION="v2.8.8" # renovate: datasource=github-releases depName=fluxcd/flux2
...
log "Installing sops"
SOPS_VERSION=v3.13.1 # renovate: datasource=github-releases depName=getsops/sops
...
log "Installing copa"
COPA_VERSION="v0.14.1" # renovate: datasource=github-releases depName=project-copacetic/copacetic
...
LAZYGIT_VERSION="v0.62.0" # renovate: datasource=github-releases depName=jesseduffield/lazygit
...
log "Installing witr"
WITR_VERSION="v0.3.2" # renovate: datasource=github-releases depName=pranshuparmar/witr
...
FRESH_VERSION="v0.3.9" # renovate: datasource=github-releases depName=sinelaw/fresh
...
CRANE_VERSION=v0.21.6 # renovate: datasource=github-releases depName=google/go-containerregistry
...
DOCKER_SCOUT_VERSION="v1.21.0" # renovate: datasource=github-releases depName=docker/scout-cli
