...
GH_CLI_VERSION="v2.88.1" # renovate: datasource=github-releases depName=cli/cli
...
log "Installing flux"
FLUX_VERSION="v2.8.2" # renovate: datasource=github-releases depName=fluxcd/flux2
...
log "Installing numr"
NUMR_VERSION="v0.5.2" # renovate: datasource=github-releases depName=nasedkinpv/numr
...
LAZYGIT_VERSION="v0.60.0" # renovate: datasource=github-releases depName=jesseduffield/lazygit
...
FRESH_VERSION="v0.2.14" # renovate: datasource=github-releases depName=sinelaw/fresh
...
CRANE_VERSION=v0.21.2 # renovate: datasource=github-releases depName=google/go-containerregistry
