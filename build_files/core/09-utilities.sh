...
GH_CLI_VERSION="v2.91.0" # renovate: datasource=github-releases depName=cli/cli
...
KUBELOGIN_VERSION="v1.36.0" # renovate: datasource=github-releases depName=int128/kubelogin
...
OMNICTL_VERSION="v1.7.0" # renovate: datasource=github-releases depName=siderolabs/omni
...
FRESH_VERSION="v0.2.25" # renovate: datasource=github-releases depName=sinelaw/fresh
