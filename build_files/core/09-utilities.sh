...
GH_CLI_VERSION="v2.101.0" # renovate: datasource=github-releases depName=cli/cli
...
KUBECTL_VERSION="v1.37.0" # renovate: datasource=github-releases depName=kubernetes/kubernetes
...
KUBECTLDFPV_VERSION="v0.5.0" # renovate: datasource=github-releases depName=yashbhutwala/kubectl-df-pv
...
log "Installing kind"
KIND_VERSION="v0.33.0" # renovate: datasource=github-releases depName=kubernetes-sigs/kind
...
KUBECOLOR_VERSION="v0.8.0" # renovate: datasource=github-releases depName=kubecolor/kubecolor/
...
OMNICTL_VERSION="v1.12.1" # renovate: datasource=github-releases depName=siderolabs/omni
...
log "Installing sops"
SOPS_VERSION=v3.13.3 # renovate: datasource=github-releases depName=getsops/sops
...
log "Installing yq"
YQ_VERSION="v4.53.6" # renovate: datasource=github-releases depName=mikefarah/yq
...
COSIGN_VERSION="v3.1.3" # renovate: datasource=github-releases depName=sigstore/cosign
...
TALOSCTL_VERSION="v1.14.1" # renovate: datasource=github-releases depName=siderolabs/talos
...
log "Installing numr"
NUMR_VERSION="v0.8.0" # renovate: datasource=github-releases depName=nasedkinpv/numr
...
FRESH_VERSION="v0.5.1" # renovate: datasource=github-releases depName=sinelaw/fresh
...
download_if_missing_cmd "$ACT_TGZ" /ctx/build_files/github-release-url.sh nektos/act "act_${MACHINE}_${HOST_ARCH}.tar.gz" "$ACT_VERSION"
