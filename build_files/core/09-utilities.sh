...
GH_CLI_VERSION="v2.98.0" # renovate: datasource=github-releases depName=cli/cli
...
KUBECTL_VERSION="v1.36.4" # renovate: datasource=github-releases depName=kubernetes/kubernetes
...
log "Installing flux"
FLUX_VERSION="v2.9.4" # renovate: datasource=github-releases depName=fluxcd/flux2
...
FRESH_VERSION="v0.4.10" # renovate: datasource=github-releases depName=sinelaw/fresh
...
CRANE_VERSION=v0.21.9 # renovate: datasource=github-releases depName=google/go-containerregistry
